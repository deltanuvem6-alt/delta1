...
const checkAndSendEmails = async () => {
    ...
    try {
        ...
        // REMOVIDO: Filtro de 5 minutos (evita perder e-mails em caso de queda do servidor)
...
// Iniciar o robô com segurança (se der erro ele reinicia em 15s)
const runRobot = async () => {
    await checkAndSendEmails();
    setTimeout(runRobot, 15000);
};
