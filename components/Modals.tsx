...
import { XIcon, UploadCloud, EyeIcon, EyeOffIcon, ShieldCheckIcon, WhatsAppIcon } from './Icons';
...
export const AddPostModal: React.FC<{
    isOpen: boolean;
    onClose: () => void;
    onSave: (data: { name: string; location: string; companyId: number; password: string; whatsapp?: string }) => void;
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        onSave({ name, location, companyId, password, whatsapp });
    };
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="Registrar Novo Posto de Serviço" footer={footer}>
            <form id="add-post-form" onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                    <label htmlFor="post-whatsapp" className="block mb-2 text-sm font-medium text-gray-300">Tel / WhatsApp do Posto (Opcional)</label>
                    <input
                        id="post-whatsapp"
                        value={whatsapp}
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title={`Editar Posto: ${post?.name}`} footer={footer}>
            <form id="edit-post-form" onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                    <label htmlFor="edit-post-whatsapp" className="block mb-2 text-sm font-medium text-gray-300">Tel / WhatsApp do Posto (Opcional)</label>
                    <input
                        id="edit-post-whatsapp"
                        name="whatsapp"
