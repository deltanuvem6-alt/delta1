    ...
    const renderContent = () => {
        switch (currentPage) {
            ...
            case PageEnum.Reports:
                return <ReportsContent events={events} posts={posts} currentUser={currentUser} onDeleteEvents={onDeleteReportEvents} />;
